            ...
            <div class="row justify-content-center">
                <div class="card shadow m-4" style="width:600px;">
                    ...
                    <div class="row card-content p-4">
                        ...
                        <div class="col p-3 text-center"><img src="image/javascript.png" alt="javascript" height="100"
                                width="100">
                            <p class="text-center pt-2">Javascript</p>
                        </div>
                        <div class="col p-3 text-center"><img src="image/bootstrap.png" alt="bootstrap" height="100"
                                width="100">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="card shadow m-4" style="min-height: 225px;">
                        <div class="card-header">
                            <h3><a href="http://www.lyceecassin-leraincy.fr/" target="_blank">Lycée Polyvalent René
                                    Cassin</a></h3>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="card shadow m-4" style="width: 19rem;">
                    ...
                    <div class="card-body p-2">
                        <h4 class="card-title"><a href="https://www.groupeprogress.com/" target="_blank">Groupe
                                Progress</a></h4>
                            ...
                            <form method="post" action="/contact">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name"
                                        aria-describedby="emailHelp" placeholder="Entrer votre nom" required>
                                </div>
                                <div class="form-group">
